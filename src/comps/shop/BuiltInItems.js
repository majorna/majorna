...
export default [
  {
    id: 'majorna',
    name: 'Majorna',
    description: 'Buy Majorna using US Dollar, Euro, Bitcoin, or Ethereum. The amount you send will be converted to mj in your account, based on the current exchange rate.',
    imageUrl: mj,
