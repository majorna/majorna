...
exports.verifyText = (text, signatureSha256Base64) => {
  return crypto.createVerify(algo).update(text).verify(config.crypto.publicKey, signatureSha256Base64, encoding)
}
